...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: #000;\n  color: white;\n  display: grid;\n  grid-template-rows: 44px auto 44px;\n}\n\nnav {\n  grid-row-start: 3;\n  position: sticky;\n  bottom: 0;\n  display: flex;\n  justify-content: space-evenly;\n  background-color: rgba(22, 22, 22, 0.94);\n}", "",{"version":3,"sources":["webpack://./src/style.sass"],"names":[],"mappings":"AAEA;EACI,sBAHS;EAIT,YAAA;EACA,aAAA;EACA,kCAAA;AADJ;;AAGA;EACI,iBAAA;EACA,gBAAA;EACA,SAAA;EAEA,aAAA;EACA,6BAAA;EACA,wCAAA;AADJ","sourcesContent":["$background: #000\n\nbody\n    background-color: $background\n    color: white\n    display: grid\n    grid-template-rows: 44px auto 44px\n\nnav\n    grid-row-start: 3\n    position: sticky\n    bottom: 0\n    \n    display: flex\n    justify-content: space-evenly\n    background-color: rgba(22, 22, 22, 0.94)"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
